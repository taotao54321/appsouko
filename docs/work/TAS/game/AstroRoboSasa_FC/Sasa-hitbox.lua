...
local COLOR_BARRIER = "#FF0000"
local COLOR_OBJ = "#00FFFF"
...
function draw_info(p1, p2)
    ...
    local info_p2cool = ""
    if p1 then
        local info_p1 = string.format("1P:(0x%02X,0x%02X),(% 03d,% 03d)",
                                      p1.x, p1.y, sasa_signed(p1.vx), sasa_signed(p1.vy))
        info_p = info_p .. info_p1
        info_p1cool = string.format("%d", p1.cool)
    end
    if p2 then
        local info_p2 = string.format(" 2P:(0x%02X,0x%02X),(% 03d,% 03d)",
